...
public class EmployeeController {
	...
	public String Principal(Employee employee) throws SQLException {

		logger.info("PRINCIPAL");

		return "employee/mainn";
	}
	...
	public String loadEmployee(Model model, Employee employee) throws SQLException {
		...
		logger.info("PREPARA MANUTENÇÂO DO EMPLOYEE");
	...
	public String deleteEmployee(Employee employee) throws SQLException {
		...
		logger.info("REMOÇÂO DE EMPLOYEE");
