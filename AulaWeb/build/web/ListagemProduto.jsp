...
<div class="container">
<h1><strong>PRODUTOS CADASTRADOS</strong></h1>
...
<tr>
    ...
    <td><a href=ProdutoServlet?action=Deletar&cod=<%= produto.getCod() %>><i style="font-size:24px;color:red" class="fa">&#xf014;</i></a></td>
    <td><a href=ProdutoServlet?action=Alterar&cod=<%= produto.getCod() %>><i class="fa fa-pencil-square-o" style="font-size:24px;color:blue"></i></a></td>
