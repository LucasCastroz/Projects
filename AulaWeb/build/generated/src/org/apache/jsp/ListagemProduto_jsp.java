...
public final class ListagemProduto_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("<h1><strong>PRODUTOS CADASTRADOS</strong></h1>\n");
      ...
      out.write("        <th>DELETAR PNG</th>\n");
      out.write("    </thead>\n");
      out.write("<tbody>\n");
      out.write("     \n");
 
List<TabelaProdutoBean> clientes = HibernateAulaDAO.listar(TabelaProdutoBean.class);

for (int i = 0; i < clientes.size(); i++) 
{
    TabelaProdutoBean produto = (TabelaProdutoBean) clientes.get(i);
      ...
      out.write("</td>\n");
      out.write("    <td><a href=ProdutoServlet?action=Deletar&cod=");
      out.print( produto.getCod() );
      out.write("><i style=\"font-size:24px;color:red\" class=\"fa\">&#xf014;</i></a></td>\n");
      out.write("    <td><a href=ProdutoServlet?action=Alterar&cod=");
      out.print( produto.getCod() );
